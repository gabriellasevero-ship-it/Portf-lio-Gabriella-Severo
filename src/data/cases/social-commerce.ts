export const socialCommerceCase = {
  slug: "social-commerce",
  title: "Social Commerce",
  subtitle: "Experiência digital para Consultoras de Beleza",
  client: "Natura &Co",
  ...
  process: {
    title: "Processo",
    steps: [
      "Discovery contínuo e entendimento profundo do negócio",
      "Benchmark e análise de soluções de mercado",
      "Pesquisa qualitativa com consultoras",
      "Co-criação com produto, negócio e tecnologia",
